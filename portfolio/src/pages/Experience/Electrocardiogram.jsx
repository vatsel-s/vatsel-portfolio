...
function Electrocardiogram() {
  return (
    <div className = "max-w-2xl mx-auto p-6 m-6 rounded-xl shadow-md flex md:flex-col items-center gap-6 border-6 border-primary p-4 rounded">
        <img src={ecg} id="imade" className="w-48 sm:w-64 md:w-96 lg:w-128" alt="iMADE Project Image" />
        <h2 className='text-xl text-primary mt-4 font-bold'>
        ...
        <div className="flex flex-col items-start md:items-left">
            ...
            <h2 className='text-md text-gray-300mt-2'>
