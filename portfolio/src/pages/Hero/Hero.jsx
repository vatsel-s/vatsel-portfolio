...
function Hero() {
  return (
    <div className = "max-w-4xl mx-auto p-6 m-6 bg-gray-110 rounded-xl shadow-md flex flex-col md:flex-row items-center gap-6">
        <img src={profile_pic} id="profile" className="w-24 sm:w-32 md:w-48 lg:w-64 rounded_full" alt="Profile Picture" />
        <div className="flex flex-col justify-center items-center md:items-center">
            ...
            <h2 className = 'text-md mt-2'>
                ...
                Outside of academics, I love playing tennis, cricket, and golf, as well as biking and playing chess.
            </h2>
        </div>
    </div>
  )
